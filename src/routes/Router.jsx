...
const PublicHomePage = lazy(
  () => import("../components/pages/home-public/home-public"),
);
const HostBloodDrivePage = lazy(
  () => import("../components/pages/host-blood-drive/host-blood-drive"),
);

const NeedBloodPage = lazy(
...
const ContactPagePrivate = lazy(
  () => import("../components/pages/contact/contact-page-private"),
);
const RegisterOtpPage = lazy(
  () => import("../components/pages/register-otp/register-otp"),
);
const Admin = lazy(() => import("../components/layouts/admin"));
const AdminLogin = lazy(
  () => import("../components/pages/admin-login/admin-login"),
);

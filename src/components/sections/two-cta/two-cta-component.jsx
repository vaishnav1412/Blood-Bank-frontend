  ...
  const ctaDetails = [
    {
      ...
      heading: "Donate blood at a hospital near you.",
    ...
    },
    {
      ...
      heading: "Search for blood donors at the closest hospital.",
      btnText: "Search blood",
      ctaLink: "/need-blood",
    },
  ];
    ...
    <WrapperSection>
      <div className="cta-content-wrapper grid place-items-start sm:grid-cols-[1fr_1fr] gap-[20px] w-full">
        {ctaDetails.map((ctaDetail) => (
          <div
            key={ctaDetail.key}
            onClick={() => navigate(ctaDetail.ctaLink)}
            className={`cta-col cursor-pointer sm:before:transition rounded-rmd overflow-hidden w-full relative z-[25] pt-[150px] pb-[30px] sm:pb-[50px] px-[30px] sm:px-[50px] ${ctaDetail.ctaClass}`}
          >

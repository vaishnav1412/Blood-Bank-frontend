...
const ProcessStepComponent = ({
	...
	return (
		<a href={stepUrl} className="process-step p-3 pr-10">
			<div className="step-number-wrapper w-[40px] h-[40px] sm:w-[50px] sm:h-[50px] bg-button_original rounded-full flex justify-center items-center mb-2 mt-5 sm:mb-5">
...
ProcessStepComponent.propTypes = {

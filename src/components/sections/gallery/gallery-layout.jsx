...
const DonationGallery = () => {
  ...
  const galleryItems = [
    {
      ...
      description: "Record-breaking 500+ donors participated in our annual drive",
      image: "https://images.unsplash.com/photo-1615461066841-6116e61058f4?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80",
      date: "Jan 15, 2024",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80",
      date: "Feb 3, 2024",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1584467735871-8db9ac8d0916?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80",
      date: "Apr 22, 2024",
      location: "Town Hall",
      donors: 42,
      likes: 156,
    ...
    },
    {
      ...
      content: "The blood you donate gives someone another chance at life. One day that someone may be a close relative, a friend, a loved one—or even you.",
    ...
    },
    {
      ...
      description: "Global celebration with awareness programs and donor felicitation",
      image: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80",
      date: "Jun 14, 2024",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1576086213369-97a306d36557?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80",
      date: "Jul 8, 2024",
      location: "IT Park",
      donors: 320,
      likes: 245,
  ...
  const filters = [
    ...
    { id: "donation-drive", label: "Donation Drives", icon: <FaHeart />, count: 4 },
    { id: "motivational", label: "Motivational", icon: <FaQuoteLeft />, count: 2 },
  ...
  const renderGalleryItem = (item) => {
    switch (item.type) {
            ...
            >
              ...
              <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <span className="hidden sm:inline">👥 {item.donors} donors</span>
                </div>
      ...
      case 'quote':
        return (
          <div className={`quote-card ${item.bgColor} rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg hover:shadow-xl transition-shadow duration-500 relative overflow-hidden`}>
            {/* Decorative Elements */}
      ...
      case 'stats':
        return (
          <div className={`stats-item ${item.bgColor} rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg hover:shadow-xl transition-shadow duration-500`}>
        ...
        <div className="relative w-full max-w-4xl max-h-[90vh]">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl overflow-hidden">
            ...
            <div className="p-4 sm:p-6">
              ...
              <p className="text-gray-600 mb-4 text-sm sm:text-base">{selectedImage.description}</p>
      ...
      <div className="donation-gallery bg-gradient-to-b from-pink-200 to-pink-100 md:-mt-80 -mt-[700px] rounded-xl sm:rounded-2xl lg:rounded-3xl p-3 sm:p-6 lg:p-8 xl:p-12 shadow-lg shadow-pink-500/20">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-3xl mx-auto px-2">
            Witness the moments that save lives. Explore our donation drives, meet our heroes, 
            and get inspired by stories of compassion.
          </p>
        </div>
        ...
        <div className="mb-8 sm:mb-12 bg-gradient-to-r from-pink-600 to-pink-400 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 text-center">
            <div>
              ...
              <div className="text-pink-100 text-xs sm:text-sm">Events Organized</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl md:text-3xl font-bold mb-1">25K+</div>
              <div className="text-pink-100 text-xs sm:text-sm">Photos & Videos</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl md:text-3xl font-bold mb-1">50K+</div>
              <div className="text-pink-100 text-xs sm:text-sm">Donors Featured</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl md:text-3xl font-bold mb-1">1M+</div>
              <div className="text-pink-100 text-xs sm:text-sm">Social Reach</div>
            </div>
          </div>
        </div>
          ...
          <div className="flex space-x-2 pb-2 min-w-max sm:min-w-0">
            {filters.map((filter) => (
              <button
                ...
                className={`filter-btn flex items-center px-3 sm:px-4 md:px-5 py-2 sm:py-3 rounded-lg sm:rounded-xl whitespace-nowrap transition-all duration-300 ${activeFilter === filter.id 
              ...
              >
                <span className="mr-1 sm:mr-2 text-sm sm:text-base">{filter.icon}</span>
                <span className="text-xs sm:text-sm md:text-base">{filter.label}</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12 gallery-grid">
          {filteredItems.map((item) => (
            <div 
              key={item.id} 
              className={item.type === 'stats' || item.type === 'quote' ? 'sm:col-span-2' : ''}
            >
        ...
        <div className="bg-pink-200 border border-pink-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 text-center">
          ...
          <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 max-w-2xl mx-auto">
            Have photos or videos from a donation drive? Share them with us and inspire others to become donors.
          </p>
